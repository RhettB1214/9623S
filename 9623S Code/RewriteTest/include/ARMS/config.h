...
// Ticks per inch
#define TPI 4166.96578277      			  // Encoder ticks per inch of forward robot movement
#define MIDDLE_TPI 4166.96578277        // Ticks per inch for the middle wheel

// Tracking wheel distances
#define TRACK_WIDTH 12.5 		  // The distance between left and right wheels (or tracker wheels)
#define MIDDLE_DISTANCE 1     // Distance from middle wheel to the robot turning center

// Sensors
#define IMU_PORT 15                           // Port 0 for disabled
#define ENCODER_PORTS 20, 18, 19                // Port 0 for disabled,
